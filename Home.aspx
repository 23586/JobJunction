<%@ Page Title="" Language="C#" MasterPageFile="~/BeforeSign.Master" AutoEventWireup="true" CodeBehind="Home.aspx.cs" Inherits="JobJunction.Home" %>
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-10">
                        <div class="cv-caption text-center">
                            <p class="pera1">Get Started as</p>
                            <asp:Button Text="Employer" CssClass="genric-btn primary" OnClick="EmployerSign" runat="server"/>
                            <asp:Button Text="Employee" CssClass="genric-btn primary" OnClick="EmployeeSign" runat="server"/>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single-process text-center mb-30">
                            <div class="process-cap">
                               <h5>Our Job Recommendation System Uses Advanced Algorithms To Analyze Your Profile And Match You With The Best Job Opportunities</h5>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6">
                        <div class="single-process text-center mb-30">
                            <div class="process-cap">
                               <h5>We Consider Your Skills, Experience, and Career Goals To Provide Recommendations That Will Help You Land Your Dream Job</h5>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6">
                        <div class="single-process text-center mb-30">
                            <div class="process-cap">
                               <h5>You can chat with your future employee or employer!</h5>
                            </div>
                        </div>
                    </div>
                </div>
